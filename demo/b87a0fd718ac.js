...
(function() {
    (function() {
        ...
        E = function(a, b) {
            var c;
            c = "" + C + "//w.usabilla.com/a/t?m=c&b=" + encodeURIComponent("b87a0fd718ac") + "&c=" + encodeURIComponent(a) + "&e=" + encodeURIComponent(b) +
                "&cb=" + (new Date).getTime();
        ...
        Q = {
            ...
            "065acb8b3e61": {
                ...
                "e": {
                    "effect": "slideout",
                    "speed": 600,
                    "location": "https:\/\/d6tizftlrpuof.cloudfront.net\/live\/i\/508eafc501c523c33c000008\/15b2c98ad794b7cac3ef4866a8e5a9108fac81ea.html"
                }
            },
            "341219753a27": {
                "v": 7,
                ...
                "e": {
                    "effect": "popout",
                    "speed": 600,
                    "location": "https:\/\/d6tizftlrpuof.cloudfront.net\/live\/i\/508eafc501c523c33c000008\/3e968600dc8d54c8c03c5d2a0defbe13b99083bd.html"
                }
            }
        };
        S = [];
...
(function() {
    ...
    function q() {
        ...
        d.open("http://api.usabilla.com/v2/f/" + "b87a0fd718ac" + "?w=" + a + "&h=" + c + "&url=" + encodeURIComponent(window.location), "_blank", "height=470,width=465")
    }
    if (d != window) {
