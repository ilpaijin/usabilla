...
(function() {
    (function() {
        ...
        E = function(a, b) {
            var c;
            c = "" + C + "//w.usabilla.com/a/t?m=c&b=" + encodeURIComponent("65faae774973") + "&c=" + encodeURIComponent(a) + "&e=" + encodeURIComponent(b) +
                "&cb=" + (new Date).getTime();
        ...
        Q = {
            ...
            "1f53e61f1ea2": {
                ...
                "t": [{
                    "type": "custom",
                    "name": "untitled-full-survey-campaign"
                }],
                "e": false
            },
            "5fef674f9fb9": {
                ...
                "e": {
                    "effect": "popout",
                    "speed": 600,
                    "location": "https:\/\/d6tizftlrpuof.cloudfront.net\/live\/i\/4f03f8e795fb10233e000000\/da790d61a22eaba1cdfe5a392eb5417a43c3903c.html"
                }
            },
            "428998ae52f8": {
                "v": 2,
            ...
            "b5ac06f4fa21": {
                ...
                "e": {
                    "effect": "popout",
                    "speed": 600,
                    "location": "https:\/\/d6tizftlrpuof.cloudfront.net\/live\/i\/4f03f8e795fb10233e000000\/407678984e47ece6cc881fa02ad8833e4c23f4bb.html"
                }
            },
            "d683374ccfdb": {
                "v": 5,
                ...
                "e": {
                    "effect": "slideout",
                    "speed": 600,
                    "location": "https:\/\/d6tizftlrpuof.cloudfront.net\/live\/i\/4f03f8e795fb10233e000000\/0b261fb11c830c81995bc31a2ec146858a524323.html"
                }
            },
            "79feb08e83a4": {
                "v": 0,
            ...
            "68cd112acb34": {
                ...
                "t": [{
                    ...
                    "match": "href",
                    "query": true,
                    "regexp": "(https\\:\/\/usabilla\\.com\/customers)"
                }, {
                    "type": "delay",
                    "time": "5000"
                }],
            ...
            "10eaab1f2fea": {
                ...
                "e": {
                    "effect": "slideout",
                    "speed": 600,
                    "location": "https:\/\/d6tizftlrpuof.cloudfront.net\/live\/i\/4f03f8e795fb10233e000000\/24880d37ed0002a3ab5b06cbb64e9c15b77948a8.html"
                }
            },
            "fafd49d0d328": {
                "v": 1,
                ...
                "e": {
                    "effect": "slideout",
                    "speed": 600,
                    "location": "https:\/\/d6tizftlrpuof.cloudfront.net\/live\/i\/4f03f8e795fb10233e000000\/6146c1d54b1122e7ca2e8945d13737977bad58a5.html"
                }
            }
        };
        S = [];
...
(function() {
    var b = "https:\/\/d6tizftlrpuof.cloudfront.net\/live\/",
        ...
        g = "<img src='resources/buttons/usabilla_white_rightSideFeedback.png' width='39' height='130' />",
...
(function() {
    ...
    function q() {
        ...
        d.open("http://api.usabilla.com/v2/f/" + "65faae774973" + "?w=" + a + "&h=" + c + "&url=" + encodeURIComponent(window.location), "_blank", "height=470,width=465")
    }
    if (d != window) {
        k.onParentLoad(function() {
            var a = "position:fixed;width:39px;height:130px;z-index:999;right:0px;top:50%;margin-top:-65px",
                c = f.body;
